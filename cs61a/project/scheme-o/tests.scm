...
;19
  (define (partitionc total maxpieces maxvalue previous)
    (cond
      ((or (< total 0) (<= maxvalue 0) (< maxpieces 0)) nil)
      ((= total 0) (cons previous nil))
      (else (append (partitionc (- total maxvalue) (- maxpieces 1) maxvalue (append previous (cons maxvalue nil))) 
              (partitionc total maxpieces (- maxvalue 1) previous)))
...
(define (list-partitions total max-pieces max-value)
    ...
    (partitionc total max-pieces max-value nil)
...
; expects ((5 2) (5 1 1) (4 3) (4 2 1) (3 3 1) (3 2 2))

(list-partitions 5 2 1)
;expect ()

(list-partitions 5 5 1)
;expect ((1 1 1 1 1))
(exit)
...
(define (append s v)
    (cond ((empty? s) (list v))
          ((contains? s v) s)
          ((> (car s) v) (cons v s))
          ((< (car s) v) (cons (car s) (append (cdr s) v)))
          (else nil)
          ))
;expect append
